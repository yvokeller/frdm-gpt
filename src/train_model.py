...
pt_total_params = sum(p.numel() for p in model.parameters())
pt_trainable_params = sum(p.numel() for p in model.parameters() if p.requires_grad)
print(f'Total parameters: {pt_total_params}')
print(f'Trainable parameters: {pt_trainable_params}')
